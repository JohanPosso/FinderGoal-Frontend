...
export default function Register() {
  ...
  const { register, users } = useStore(); // Access users to check for existing email (optional)
    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className={`w-full ${colorsSporty.accentOrange} hover:${colorsSporty.accentOrangeHover} ${colorsSporty.primaryText} py-3 rounded-lg font-bold uppercase tracking-wide transition-all duration-300 text-lg shadow-lg`}
        >
          Registrarse
        </motion.button>
